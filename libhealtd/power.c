...
static void endeavoru_power_init(struct power_module *module)
{
    ...
    ALOGI("endeavoru_power_init %s", governor);
}
...
static void endeavoru_power_set_interactive(struct power_module *module, int on)
{
	...
	ALOGI("endeavoru_power_set_interactive %s %d", governor, on);
                            ...
                            void *data)
{
    ...
    //ALOGI("endeavoru_power_hint :%d", hint);
    switch (hint) {
    case POWER_HINT_VSYNC:
    	//ALOGI("endeavoru_power_hint POWER_HINT_VSYNC");
        break;
    case POWER_HINT_INTERACTION:
        //ALOGI("endeavoru_power_hint POWER_HINT_INTERACTION");
        break;
    case POWER_HINT_VIDEO_ENCODE:
        //ALOGI("endeavoru_power_hint POWER_HINT_VIDEO_ENCODE");
        break;
    case POWER_HINT_CPU_BOOST:
        //ALOGI("endeavoru_power_hint POWER_HINT_CPU_BOOST");
        break;
    default:
        //ALOGI("endeavoru_power_hint unknown:%d", hint);
        break;
    }
}
