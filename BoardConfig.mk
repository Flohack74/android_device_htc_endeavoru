...
WIFI_MODULES:
	...
	$(MAKE) -C $(KERNEL_OUT)/COMPAT/$(TARGET_MODULES_SOURCE_DIR) O=$(KERNEL_OUT)/COMPAT KERNEL_DIR=$(KERNEL_OUT) KLIB=$(KERNEL_OUT) KLIB_BUILD=$(KERNEL_OUT) ARCH=$(TARGET_ARCH) CROSS_COMPILE="/home/florian/halium-5.1/prebuilts/misc/linux-x86/ccache/ccache /home/florian/halium-5.1/prebuilts/gcc/linux-x86/arm/arm-eabi-4.8/bin/arm-eabi-"
