...
#Fake
BOARD_RECOVERYIMAGE_PARTITION_SIZE := 93886080
...
BOARD_GLOBAL_CPPFLAGS             += -DUSES_TI_MAC80211
...
#libsymbols BOARD_GLOBAL_CPPFLAGS += -DADD_LEGACY_ACQUIRE_BUFFER_SYMBOL
TARGET_NEEDS_NON_PIE_SUPPORT := true
BOARD_GLOBAL_CPPFLAGS += -DTARGET_NEEDS_HWC_V0
BOARD_GLOBAL_CPPFLAGS += -DBOARD_CANT_REALLOCATE_OMX_BUFFERS
...
BOARD_GLOBAL_CPPFLAGS += -DALLOW_LOCAL_PROP_OVERRIDE=1 -DALLOW_DISABLE_SELINUX=1 -DALLOW_ADBD_ROOT=1
WITH_DEXPREOPT := true
...
# Flags
BOARD_GLOBAL_CPPFLAGS += -DMR0_AUDIO_BLOB -DMR0_CAMERA_BLOB -DNEEDS_VECTORIMPL_SYMBOLS 
